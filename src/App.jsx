...
export default function App() {
  ...
  const isDemoJoin = window.location.pathname === '/demo/join'
  ...
  useEffect(() => {
    if (isInvitation || isDemo || isDemoJoin) { setLoading(false); return }
  ...
  // 🎮 Routes démo (avant tout le reste)
  if (isDemoJoin) return <DemoJoin />
